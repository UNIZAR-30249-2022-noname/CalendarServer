...
// Source: /mnt/c/Users/Equipo/Desktop/LIS/Gateway/src/internal/core/ports/services.go
...
func (m *MockUploadDataService) UpdateByCSV(csv, privileges string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateByCSV", csv, privileges)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUploadDataServiceMockRecorder) UpdateByCSV(csv, privileges interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateByCSV", reflect.TypeOf((*MockUploadDataService)(nil).UpdateByCSV), csv, privileges)
}
...
func (m *MockSpacesService) FilterBy(arg0 domain.SpaceFilterParams) ([]domain.Space, error) {
	m.ctrl.T.Helper()
...
func (m *MockSpacesService) GetReservesOwner(owner string) ([]domain.Reserve, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSpacesServiceMockRecorder) GetReservesOwner(owner interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReservesOwner", reflect.TypeOf((*MockSpacesService)(nil).GetReservesOwner), owner)
}
...
func (m *MockSpacesService) ReserveBatch(spaces []string, init, end domain.Hour, dates []string, person string) (string, error) {
	m.ctrl.T.Helper()
...
// DownloadIssues mocks base method.
func (m *MockIssueService) DownloadIssues(building string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DownloadIssues", building)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DownloadIssues indicates an expected call of DownloadIssues.
func (mr *MockIssueServiceMockRecorder) DownloadIssues(building interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadIssues", reflect.TypeOf((*MockIssueService)(nil).DownloadIssues), building)
}
