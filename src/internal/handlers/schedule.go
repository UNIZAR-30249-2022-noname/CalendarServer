...
func (hdl *HTTPHandler) GetAvailableHours(c *gin.Context) {
	...
	availableHours, err := hdl.SchedulerService.GetAvailableHours(terna)
...
func (hdl *HTTPHandler) PostUpdateScheduler(c *gin.Context) {
	...
	//Execute service
	lastMod, err := hdl.SchedulerService.UpdateScheduler(listEntries, terna)
	if err == nil {
...
func (hdl *HTTPHandler) ListDegrees(c *gin.Context) {
	list, err := hdl.SchedulerService.ListAllDegrees()
	if err == nil {
		fmt.Println(list)
...
func (hdl *HTTPHandler) GetEntries(c *gin.Context) {
	...
	entries, err := hdl.SchedulerService.GetEntries(terna)
...
func (hdl *HTTPHandler) GetICS(c *gin.Context) {
	...
	list, err := hdl.SchedulerService.GetICS(terna)
	if err == nil {
		fmt.Println(list)
		c.JSON(http.StatusOK, list)
	} else {
